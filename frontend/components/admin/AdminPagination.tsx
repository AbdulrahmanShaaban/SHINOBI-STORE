...
export default function AdminPagination({ page, totalPages, onPageChange }: AdminPaginationProps) {
  ...
  const btn =
    'rounded-lg border border-[#2A2A3A] px-4 py-2 font-cinzel text-xs font-bold tracking-wider text-[#B8B8CC] hover:border-[#FF6B00] hover:text-[#F0F0F0] transition-colors disabled:opacity-40 disabled:cursor-not-allowed';
  return (

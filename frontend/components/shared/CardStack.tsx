...
export default function CardStack() {
  useGSAP(() => {
    ...
    // Fixed header height for perfect stacking
    ...
    // Card 2: Complex entry from bottom-left with curve and rotation
    // Pin exactly at headerHeight (60px) - no gaps
    tl.fromTo(
      cards[1],
      {
        y: 600,
    ...
    // Parallax effect on Card 2 content (moves slower)
    tl.fromTo(
      cardContents[1],
      {
        y: 100,
    ...
    // Card 3: Complex entry from bottom-right with curve and rotation
    // Pin exactly at headerHeight * 2 (120px) - no gaps
    tl.fromTo(
      cards[2],
      {
        y: 600,
    ...
    // Parallax effect on Card 3 content (moves slower)
    tl.fromTo(
      cardContents[2],
      {
        y: 100,
    ...
    // Card 4: Complex entry from bottom-left with curve and rotation
    // Pin exactly at headerHeight * 3 (180px) - no gaps
    tl.fromTo(
      cards[3],
      {
        y: 600,
    ...
    // Parallax effect on Card 4 content (moves slower)
    tl.fromTo(
      cardContents[3],
      {
        y: 100,
  ...
  return (
    <section className="card-stack-container min-h-screen bg-[#0A0A0F] py-20">
      <div className="container absolute top-50 left-1/2 -translate-x-1/4 ">
        <div className="max-w-2xl mx-auto relative">
          {/* Card 1 */}
          <div className="card-item absolute top-0 left-0 right-0">
            <div className="card-header relative bg-[#F5E6C8] h-[60px] px-6 flex items-center justify-between border-b-2 border-[#FF7F00] box-border m-0">
            ...
            <div className="card-body bg-[#1A1A1A] rounded-b-xl p-8 flex flex-col items-center text-center pb-[35vh]">
              <div className="card-content flex flex-col items-center text-center">
                <img src="/kunai.svg" alt="" className="w-20 h-20 mb-6" />
